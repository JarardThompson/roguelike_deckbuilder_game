...
enum CharacterType {ALL, ROGUE, WARRIOR, WIZARD}

@export var relic_type: String
...
# This method should be implemented by event-based relics which connect to the
# EventBus to make sure that they are disconnected when a relic gets removed
